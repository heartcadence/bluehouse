  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
      <div className={`max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 p-12 rounded-sm border backdrop-blur-md ${
        ...
        {/* Right Side: Rebuilt Original Form with Accessibility Labels */}
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="submit" className="w-full bg-deep-teal text-off-white py-4 font-bold tracking-widest uppercase hover:bg-muted-gold transition-colors shadow-lg mt-4 rounded-sm">
            Send Message
          </button>
        </form>
      </div>

...
type ViewMode = 'landing' | 'storefront';
...
const App: React.FC = () => {
  ...
  const toggleView = () => {
    ...
    setCurrentView(prev => prev === 'landing' ? 'storefront' : 'landing');
  };
  ...
  return (
    <div className={`min-h-screen font-body transition-colors duration-300 selection:bg-muted-gold selection:text-deep-teal ${appContainerClass}`}>
      ...
      <main className="pt-20">
        ...
        {currentView === 'landing' ? (
            <LandingPage onSwitchToStore={toggleView} isDarkMode={isDarkMode} />
        ) : (
            /* STOREFRONT VIEW */
            <>
                {/* Storefront Hero */}
                <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in">
                        ...
                        <h1 className={`font-display text-5xl md:text-6xl lg:text-7xl mb-6 leading-tight transition-colors duration-300 ${headingColor}`}>
                        Select Your <br/> 
